...
public class RecommendDetailKindFragment_Kind3 extends Fragment implements OnClickListener {
    Context context;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        RecommendDetailKindFragment_RecyclerViewAdapter adapter
                = new RecommendDetailKindFragment_RecyclerViewAdapter(3);
    ...
    public RecommendDetailKindFragment_Kind3() {
